...
- `766a53c` — docs: perbaiki klaim basi `schemaVersion = 9` di CLAUDE.md (kode sudah 21) — utang D.4 di Item 41 PLAN.md, ditemukan lewat audit pra-rilis; klaim stack lain (Riverpod 2.5, GoRouter 14) diverifikasi masih akurat thd pubspec, jadi hanya baris ini yang diubah; D.4 dihapus dari PLAN.md
