...
void main() {
  test(
    ...
    v14.execute('CREATE TABLE product_units(id TEXT PRIMARY KEY);');
    // customers diperlukan agar migrasi v28 (addColumn locally_modified) tak gagal.
    v14.execute('CREATE TABLE customers(id TEXT PRIMARY KEY);');
    v14.dispose();
    ...
    expect(ver.data.values.first, 31); // schemaVersion terkini
